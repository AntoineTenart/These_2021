...
\begin{figure}
    ...
    \caption{Time integrated 2D MCP image illustrating the presence of a saturation cross at $\pm 45^{\circ}$.}
...
\begin{figure}
    ...
    \caption{Entropy per particle for various values of $u$. Almost all points are compatible with the BEC entropy $S_{0} / N= 0.72(7) \ k_{B}$.}
