...
\noindent The Bloch waves are the sum of the localized Wannier functions $w_{n, j}$ that can be interpreted as the wave-functions of a particle located in lattice site $j$. The Bloch and Wannier functions for various lattice depths are represented on Fig.-\ref{fig:bloch_wannier}.
...
\begin{figure}
    ...
    \caption[2D Gutzwiller density profiles for various atom numbers at $s=18$]{Gutzwiller density profiles for various atom numbers at $s=18$ with $n$ the number of atoms per site and $x$,$y$ the positions in units of lattice spacing.}
