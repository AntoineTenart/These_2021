...
\begin{equation}
    \gtwo_{A,N} (\delta \bm{k}) = 1 + \eta_{A,N} \prod_{i=x,y,z} \exp \left(\frac{-\delta k_i^2}{2 \sigma_i}\right)
\end{equation}

Practically speaking, the values of the $\gtwo$ function are recorded in a 3D histograms made of cubic voxels whose size will be denoted $\Delta k_{\parallel}$.
