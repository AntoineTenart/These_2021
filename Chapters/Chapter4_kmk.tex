...
\begin{itemize}
    ...
    \item Dipsersion relation of the lattice \NOTE{COMPLETER}
    \item Is is also not so clear of the pairs are projected into the different Brillouin zones when performing the time-of-flight measurement. This could also makes us miss some pairs (\NOTE{BOF}).
\end{itemize}
